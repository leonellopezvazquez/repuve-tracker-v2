...
namespace PIPS.BOSSLogins {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="LoginsServiceSoap", Namespace="http://tempuri.org/")]
    public partial class LoginsService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public LoginsService() {
            this.Url = "http://localhost:8088/BOSS/Services/LoginsService.asmx";
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetLogins", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public Login[] GetLogins(string clientName) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetLogins(string clientName, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GetLogins", new object[] {
                        clientName}, callback, asyncState);
        }
        
        /// <remarks/>
        public Login[] EndGetLogins(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((Login[])(results[0]));
        }
        
        /// <remarks/>
        public void GetLoginsAsync(string clientName) {
            this.GetLoginsAsync(clientName, null);
        }
        
        /// <remarks/>
        public void GetLoginsAsync(string clientName, object userState) {
            ...
            this.InvokeAsync("GetLogins", new object[] {
                        clientName}, this.GetLoginsOperationCompleted, userState);
        }
